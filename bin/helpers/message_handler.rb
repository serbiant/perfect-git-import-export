module MessageHandler
  ...
  DEFAULT_MESSAGES = {
      ...
      :repository => 'Please provide me with Github repository name! (--repository, -r option)',
      :auth_failed => 'Github authentication failed! Please try again.',
      :type => 'Please provide the type of work - import or export. (-t, --type option)',
      :type_invalid => 'Type is invalid! Two types are supported - \'import\' and \'export\'',
      :value_invalid => 'Invalid value! Aborting.',
      :override => 'Error: Method mush be overridden.'
  }
